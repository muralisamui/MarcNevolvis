...
Wrm.Common = function (executionContext) {
    ...
    var lockFormOnRecordLockTimeoutReachedV2 = async (DateTimeFieldName, formContext) => {
        DateTimeFieldName = typeof DateTimeFieldName !== 'undefined' ? DateTimeFieldName : 'createdon';
        var temp;
        var isLockTimeout = await Wrm.Common.IsLockTimeoutReachedV2(DateTimeFieldName, formContext)
        // .then((result)=>{
        //     temp = result;
        // }
        // );
    ...
    var isLockTimeoutReachedV2 = async (DateTimeFieldName, formContext) => {
        DateTimeFieldName = typeof DateTimeFieldName !== 'undefined' ? DateTimeFieldName : 'createdon';
        ...
        var LockTimeout = await Wrm.Common.GetWrmSettingV2("WRM.General.RecordLockTimeout");
        if (LockTimeout !== null && LockTimeout !== "") {
            var nowDate = new Date(); // Now
